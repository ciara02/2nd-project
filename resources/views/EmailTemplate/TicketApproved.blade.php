							...
							<table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateContainer">
								<tr>
									<td>
										<div class="header">
											...
											<h3>TICKET  NUMBER:  <strong>{{ $ticket->ticket_number }} </strong> APPROVED  </h3>
											<div class="padding"></div>
										</div>
									</td>
								...
								<tr>
									<td valign="top" class="bodyContent" mc:edit="body_content">
										...
										<strong><p>Good day {{ $ticket->contact_name }},  </p></strong>
										...
										<p>You may use this Ticket number <strong>{{ $ticket->ticket_number }}</strong> in all communications related on this request.</p>
							...
							<table width="100%" border="0" cellpadding="0" cellspacing="0" id="templateContainerFooter">
								<tr>
									<td valign="top" width="100%" mc:edit="footer_unsubscribe">
										...
										<h6 style="text-align:center;">  © {{ date('Y') }} Copyright VST ECS Phils. All rights reserved. </h6>
									</td>
								</tr>
							</table>
						</td>
