							...
							<table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateContainer">
								<tr>
									<td>
										<div class="header">
											...
											<h3>STATUS UPDATE FOR THE TICKET  NUMBER:  <strong>{{ $ticket->ticket_number }}</strong>  </h3>
											<div class="padding"></div>
										</div>
									</td>
								...
								<tr>
									<td valign="top" class="bodyContent" mc:edit="body_content">
										...
										<p>Kindly see the status update of your ticket <strong>{{ $ticket->ticket_number }}</strong>.</p><p>
											{{ $newStatusRecord->status === 'Custom'
												? $newStatusRecord->custom_status
