							...
							<table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateContainer">
								<tr>
									<td>
										<div class="header">
											...
											<h3>TICKET  NUMBER:  <strong>{{ $ticket->ticket_number }} </strong>  </h3>
											<div class="padding"></div>
										</div>
									</td>
								...
								<tr>
									<td valign="top" class="bodyContent" mc:edit="body_content">
										...
										<strong><p>Good day {{ $assignRecord->assign_name ?? 'Assignee' }},</p></strong>
										<p>We have assigned this ticket [<strong>{{ $ticket->ticket_number }} </strong>] to you. </p>
										...
										<p>Contact Number: {{$ticket->contact_number}} </p>
