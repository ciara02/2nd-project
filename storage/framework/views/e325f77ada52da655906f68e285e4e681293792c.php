							...
							<table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateContainer">
								<tr>
									<td>
										<div class="header">
											...
											<h3>TICKET  NUMBER:  <strong><?php echo e($ticket->ticket_number); ?> </strong>  </h3>
											<div class="padding"></div>
										</div>
									</td>
								...
								<tr>
									<td valign="top" class="bodyContent" mc:edit="body_content">
										...
										<strong><p>Good day <?php echo e($assignRecord->assign_name ?? 'Assignee'); ?>,</p></strong>
										<p>We have assigned this ticket [<strong><?php echo e($ticket->ticket_number); ?> </strong>] to you. </p>
										<p>Please immediately review the case and reach the customer if you deem necessary</p>
										<p>Otherwise, update the ticket of the action done.</p>
										<p>Concern: <?php echo e($ticket->concern); ?> </p>
										<p>Contact Number: <?php echo e($ticket->contact_number); ?> </p>
										<?php if(!empty($departments)): ?>
                                            <?php $__currentLoopData = $departments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dept): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <p>Contract: <?php echo e($dept->prod_name); ?></p>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        <?php endif; ?>
										<p>
                                            Date Reported:
                                            <?php echo e($ticket->date_created ? \Carbon\Carbon::parse($ticket->date_created)->format('M-d-Y h:i A') : 'N/A'); ?>
...
</html><?php /**PATH D:\Project 2025\iSupport-Ticketing\resources\views/EmailTemplate/TicketAssigned.blade.php ENDPATH**/ ?>