...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
 <title></title>
	...
	.content {width: 100%; max-width: 600px;     margin-top: 50px; }
	...
	.closing-remark { margin-top:  60px; border-bottom: 1px solid #ddd; }
	.header { /*padding: 50px 20px 10px; */background-color: #3a3a3a; }
	.header h3 { text-align: center; font-weight: bold; color: #f5ef3e;}
	.padding { height: 30px; }
							...
							<table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateContainer">
								<tr>
									<td>
										<div class="header">
											...
											<h3>TICKET  NUMBER:  <strong><?php echo e($ticket->ticket_number); ?> </strong> APPROVED  </h3>
											<div class="padding"></div>
										</div>
									</td>
								...
								<tr>
									<td valign="top" class="bodyContent" mc:edit="body_content">
										...
										<strong><p>Good day <?php echo e($ticket->contact_name); ?>,  </p></strong>
										<p>Good news. Your support ticket has been approved and will be assigned to a technical support engineer.</p>
										<p>He or she may contact you for further details on this concern.</p>
										<p>Otherwise, a status update will be sent to you shortly.</p>
										<p>You may use this Ticket number <strong><?php echo e($ticket->ticket_number); ?></strong> in all communications related on this request.</p>
										
										<div class="closing-remark">
										<p>If you have any concerns and inquries please call <strong>88309972-74 </strong>  or You may email the team( <strong>techsupport@msi-ecs.com.ph</strong> ) </p>
										</div>
									</td>
								</tr>
							...
							<table width="100%" border="0" cellpadding="0" cellspacing="0" id="templateContainerFooter">
								<tr>
									<td valign="top" width="100%" mc:edit="footer_unsubscribe">
										<h6 style="text-align:center;">  VST ECS Phils. Inc. </h6>
										<h6 style="text-align:center;"> MSI-ECS COMPLEX, M. Eusebio Avenue San Miguel, Pasig City</h6>
										<h6 style="text-align:center;">Metro Manila, Philippines 1600</h6>
										<h6 style="text-align:center;">  © <?php echo e(date('Y')); ?> Copyright VST ECS Phils. All rights reserved. </h6>
									</td>
								</tr>
							</table>
						</td>
...
</html><?php /**PATH D:\Project 2025\iSupport-Ticketing\resources\views/EmailTemplate/TicketApproved.blade.php ENDPATH**/ ?>