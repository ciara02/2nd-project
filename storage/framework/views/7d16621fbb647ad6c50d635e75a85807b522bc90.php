							...
							<table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateContainer">
								<tr>
									<td>
										<div class="header">
											...
											<h3>TICKET  NUMBER:  <strong><?php echo e($ticket->ticket_number); ?> </strong> REJECTED </h3>
											<div class="padding"></div>
										</div>
									</td>
								...
								<tr>
									<td valign="top" class="bodyContent" mc:edit="body_content">
										...
										<p>We regret to inform you that your ticket number <strong><?php echo e($ticket->ticket_number); ?> </strong> has been rejected due to the reasons below.</p>
										<p><?php echo e($ticket->declined_reason); ?></p>
										<p>Kindly reach the contact details below to know more on how can we assist you.</p>
...
<?php /**PATH D:\Project 2025\iSupport-Ticketing\resources\views/EmailTemplate/TicketDeclined.blade.php ENDPATH**/ ?>