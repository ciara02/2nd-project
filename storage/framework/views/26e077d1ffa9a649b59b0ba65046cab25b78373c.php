...
<html xmlns="http://www.w3.org/1999/xhtml">
	 ...
	 <body style="margin: 10px; padding: 30px; font-family:'Calibri'; font-weight: 300; line-height: 1.5em; text-align: left; background-color: #fff; border-radius:15px;">
			<h3 style="font-family:'Calibri';font-size: 20px" >Good day <?php echo e($assignRecord->assign_name ?? 'Assignee'); ?>, </h3> 
		<p style="font-family:'Calibri';font-size: 16px"> 
			We have reassigned this ticket [<strong><?php echo e($ticket->ticket_number); ?></strong>] to  another engineer.
        <table align="center" cellpadding="0" cellspacing="0" width="600" style="background-color:#fff; margin: 10px 0; padding: 50px; border-radius: 15px; ">
			<tr>
				 ...
				 <p><strong>Company Name:</strong><?php echo e($ticket->company_name); ?> </p>
				  <p><strong>Company Email:</strong><?php echo e($ticket->cotact_email); ?> </p>
					<p><strong>Concern:</strong> <?php echo e($ticket->concern); ?> </p>
...
</html><?php /**PATH D:\Project 2025\iSupport-Ticketing\resources\views/EmailTemplate/TicketReAssigned.blade.php ENDPATH**/ ?>